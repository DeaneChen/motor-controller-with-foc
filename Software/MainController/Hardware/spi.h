 ...
 * @LastEditTime : 2022-03-03 14:25:38
...
#define SPI_SDI_READ()       HAL_GPIO_ReadPin(SPI_SDI_GPIO_Port,SPI_SDI_Pin)
#define SPI_GetTime()        HAL_GetTick()

#define SPI_WAIT_TIME_LIMIT  100       //总线最大等待时间,用于总线读取数据时等待超时报错

typedef  uint8_t  SPI8BitsType;
typedef uint16_t  SPI16BitsType;
typedef uint32_t  SPI32BitsType;
